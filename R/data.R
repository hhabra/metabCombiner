...
#'
#' An example metabolomics dataset consisting of human plasma from Red Cross
#' and CHEAR cohorts, plus pooled aliquots and negative controls, acquired
#' with a 30 minute total Reversed-Phase Liquid Chromatography and a QTOF
...
#' An example metabolomics dataset consisting of human plasma from Red Cross
#' and CHEAR cohorts, plus pooled aliquots and negative controls, acquired
#' with a 20 minute total Reversed-Phase Liquid Chromatography & QTOF-MS
#' instrument in the positive ionization mode.
#'
